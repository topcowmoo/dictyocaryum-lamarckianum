...
import { AuthContext } from "../context/AuthContext"; // Context for authentication functionality
      ...
      <div className="absolute top-4 left-4 cursor-pointer">
        {isDarkMode ? (
          <PiSunDuotone
            ...
            className="dark:text-alltext-dark text-alltext-light dark:hover:text-highlight-dark hover:text-highlight-light cursor-pointer"
          />
        ) : (
          <PiMoonDuotone
            size={30}
        ...
        <div className="flex flex-col items-center justify-center w-full max-w-lg gap-y-6 profile-card-wrapper">
          ...
          <div className="p-4 pb-6 dark:bg-display-dark bg-sidebar-light rounded-[4px] shadow-lg w-full max-w-sm mb-5">
            ...
            <Button
              ...
              iconSize={20}
              label="Logout"
              onClick={() => logout(navigate)} // Use the logout function from AuthContext
              className="dark:text-alltext-dark text-alltext-light w-full text-sm"
              size="md"
            />
          </div>
