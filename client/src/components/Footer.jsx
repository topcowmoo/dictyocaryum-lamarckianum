...
function Footer() {
  ...
  return (
    <footer
      className="relative bottom-0 left-0 right-0 flex items-center justify-between p-4 text-[10px] md:text-[14px] w-full z-10 dark:bg-hefo-dark bg-purple-300 border-t-2 border-display-dark dark:border-display-light"
      role="contentinfo"
    >
      {/* Icon Section */}
      <div
